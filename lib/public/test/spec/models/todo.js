...
define(["models/todo", "collections/todos"], function(Todo, TodoList) {
  ...
  return describe("TodoList", function() {
    ...
    it("should return the remaining count", function() {
      var count;
      count = this.collection.getRemainingCount();
      return expect(count).toEqual(1);
    });
    it("should return the completed count", function() {
      var count;
      count = this.collection.getCompletedCount();
      return expect(count).toEqual(1);
    });
    return it("should return the total count", function() {
      var count;
